...
public class TestReminderAppController {
	...
	public void getReminder() throws Exception {
		...
		Mockito.when(reminderService.getAllReminders(Mockito.anyString()))
				.thenReturn(reminderResponseEntity);

		ResponseEntity<ReminderResponse> Response = reminderAppController.getAllReminder("Test");
	...
	public void addReminder() throws Exception {
		...
		Mockito.when(reminderService.persitReminder(Mockito.any())).thenReturn(reminderResponseEntity);
